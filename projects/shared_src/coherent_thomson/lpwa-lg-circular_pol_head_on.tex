...
\end{align}
{\bf \color{orange} TO DO: to check explicitly the sign of topological charge $m$ in the phase}

Using the transverse trajectory in Eq.~(\ref{trajectory_mono_gamma_head_on}), we obtain
\begin{align}
     & {\bf r}_{\perp}(\phi)
    = {\boldsymbol{\mathfrak R}}_{0\perp}
    -\frac{e_0 A_0}{k_L(n\cdot p_0)}
    \left\{
    ...
    \right\},\nonumber       \\
     & z(\phi)
    =\left[\frac{p_0^3}{n\cdot p_0}
        +\frac{e_0^2A_0^2}{4(n\cdot p_0)^2}\right]\phi
    +\frac{e_0^2A_0^2(\zeta_x^2-\zeta_y^2)}{8k_L(n\cdot p_0)^2}
...
Also, here only the circular polarization will be discussed for simplicity $\zeta_x=\zeta_y=\frac{1}{\sqrt{2}}$.
With these, we have
\begin{align}
     & {\bf r}_{\perp}(\phi)
    = {\boldsymbol{\mathfrak R}}_{0\perp}
...
The particle interacts with an LG beam of not too large intensity, of indices $(p,m)$, the field is approximated as monochromatic, with a $\rho_0$ dependent amplitude, and an initial phase $m\varPhi_0$.
Consider a plane wave monochromatic field of frequency $\omega_L=ck_L$, propagating along the $Oz$ direction, described by the vector potential
\begin{align}
    {\bm A}(\phi)=A_0\left[ {\bm e}_x\zeta_x \cos(k_L\phi-m_L\varPhi_0)+{\bm e}_y\zeta_y\sin(k_L\phi-m_L\varPhi_0)\right],\qquad \zeta_x^2+\zeta_y^2=1,\qquad \phi=ct-z
\end{align}
Consider a charged particle, of charge $e_0$, in the presence of the field with the initial conditions
\begin{align}
    {\bm p}_i={\bm p}_0, \qquad{\bm A}({\bm r}_i,t_i)={\bm A}_0
\end{align}
i.e. the initial momentum is ${\bm p}_0$ and the value of the vector potential at the initial position of the particle is ${\bm A}_0$. With these, the trajectory is
\begin{align}
     & \bm{r}_{0\perp}(\chi)=\int_{c t_i-z_i}^\chi \mathrm{d} \phi \frac{\bm{p}_{0 \perp}-e \bm{A}(\phi)}{n_{\mathrm{L}} \cdot p_0}, \quad z_0(\chi)=\int_{c t_i-z_i}^\chi \mathrm{d} \phi F(\phi),\quad \chi = ct-z\nonumber                                      \\
     & F(\chi) =\frac{e^2 \mathcal{A}^2(\chi)}{2\left(n_{\mathrm{L}} \cdot p_0\right)^2}+\frac{p_{0 z}}{n_{\mathrm{L}} \cdot p_0}, \qquad e^2 \mathcal{A}^2(\chi)=e^2 \mathbf{A}^2(\chi)-2 e \mathbf{A}(\chi) \cdot \mathbf{p}_{0 \perp}, \qquad n_L=(1,{\bm e}_z)
\end{align}
We discuss the particular case:
\begin{align}
    t_i=0,\qquad z_i=0,\qquad {\bm p}_0 = 0
\end{align}
with this, the trajectory becomes, up to a constant which depends on the initial condition
\begin{align}
    {\bm r}_{0\perp}(\chi) & =\frac{-eA_0}{mc}\int\limits_{0}^\chi d\phi\left[ {\bm e}_x\zeta_x \cos(k_L\phi-m_L\varPhi_0)+{\bm e}_y\zeta_y\sin(k_L\phi-m_L\varPhi_0)\right]\nonumber                                              \\
                           & =\frac{-eA_0}{mc}\frac1{k_L}\left[{\bm e}_x\zeta_x\sin(k_L\chi-m_L\varPhi_0)-{\bm e}_y\zeta_y\cos(k_L\chi-m_L\varPhi_0)\right]\nonumber                                                               \\
    z_0(\chi)              & = \frac{e^2A_0^2}{2(mc)^2}\int\limits_0^\chi d\phi\left[\zeta_x^2\cos^2(k_L\phi-m_L\varPhi_0)+\zeta_y^2\sin^2(k_L\phi-m_L\varPhi_0)\right]\nonumber                                                   \\
                           & =\frac{e^2A_0^2}{4(mc)^2}\left[\chi+\frac{\zeta_x^2-\zeta_y^2}{2k_L}\sin(2k_L\chi-2m_L\varPhi_0)\right]+z_i, \qquad z_i = \frac{e^2A_0^2}{4(mc)^2}\frac{\zeta_x^2-\zeta_y^2}{2k_L}\sin(2m_L\varPhi_0)
\end{align}
With the above choice the particle is at $z=0$ at the initial moment. With the notation
\begin{align}
    \xi = \frac{-e A_0}{mc}
\end{align}
the trajectory is
\begin{align}
     & {\bm r}_{0\perp}(\chi)=\frac{\xi}{k_L}\left[{\bm e}_x\zeta_x\sin(k_L\chi-m_L\varPhi_0)-{\bm e}_y\zeta_y\cos(k_L\chi-m_L\varPhi_0)\right]                                                  \\
     & z_0(\chi)=\frac{\xi^2}4\left[\chi+\frac{(\zeta_x^2-\zeta_y^2)\sin(2k_L\chi-2m_L\varPhi_0)}{2k_L}\right]+z_i,\qquad z_i = \frac{\xi^2}4\frac{\zeta_x^2-\zeta_y^2}{2k_L}\sin(2m_L\varPhi_0)
\end{align}
The particle velocity is
\begin{align}
     & {\boldsymbol\beta}=\frac{d{\bm r}(\phi)}{d\phi}\frac{d\phi}{d (ct)}=\frac{d{\bm r}(\phi)}{d\phi}(1-\beta_z) \\
     & \beta_z =\frac{\xi^2}4\left[1+(\zeta_x^2-\zeta_y^2)\cos(2k_L\phi-2m_L\varPhi_0)\right](1-\beta_z)
\end{align}
i.e.
\begin{align}
     & \beta_z(\phi) =\frac{F(\phi)}{1+F(\phi)},\qquad F(\phi) = \frac{\xi^2}4\left[1+(\zeta_x^2-\zeta_y^2)\cos(2k_L\phi-2m_L\varPhi_0)\right]                 \\
     & {\boldsymbol{\beta}}_\perp(\phi)=\xi\left[{\bm e}_x\zeta_x\cos(k_L\phi-m_L\varPhi_0)+{\bm e}_y\zeta_y\sin(k_L\phi-m_L\varPhi_0)\right]\frac1{1+F(\phi)}
\end{align}
...
\begin{align}
     & {\bm r}(t) -{\boldsymbol{\mathfrak R}}_0={\bm r}_0(t)\nonumber                                                                                                                                           \\
     & {\bm r}_{0\perp}(\phi)=\frac{\xi}{k_L}\left[{\bm e}_x\zeta_x\sin(k_L\phi-m_L\varPhi_0)-{\bm e}_y\zeta_y\cos(k_L\phi-m_L\varPhi_0)\right]                                                                 \\
     & z_0(\phi)=\frac{\xi^2}4\left[\phi+\frac{(\zeta_x^2-\zeta_y^2)\sin(2k_L\phi-2m_L\varPhi_0)}{2k_L}\right] -z_i                                                                                             \\
     & \beta_z(\phi) =\frac{F(\phi)}{1+F(\phi)},\qquad  {\boldsymbol{\beta}}_\perp(\phi)=\xi\left[{\bm e}_x\zeta_x\cos(k_L\phi-m_L\varPhi_0)+{\bm e}_y\zeta_y\sin(k_L\phi-m_L\varPhi_0)\right]\frac1{1+F(\phi)} \\
     & F(\phi) = \frac{\xi^2}4\left[1+(\zeta_x^2-\zeta_y^2)\cos(2k_L\phi-2m_L\varPhi_0)\right]
\end{align}
...
\begin{align}
    d\phi = c (1-\beta_z(\phi)) dt = c\frac1{1+F(\phi)} dt,\qquad \rightarrow \qquad dt=\frac1c d\phi(1+F(\phi))
\end{align}
is also convenient to redefine the velocity
\begin{align}
     & {\boldsymbol{\beta}} = \frac1{1+F(\phi)}\tilde{\boldsymbol{\beta}}(\phi)                                                                       \\
     & \tilde{\boldsymbol{\beta}}_\perp(\phi) =\xi\left[{\bm e}_x\zeta_x\cos(k_L\phi-m_L\varPhi_0)+{\bm e}_y\zeta_y\sin(k_L\phi-m_L\varPhi_0)\right], \\
     & \tilde\beta_z(\phi) =F(\phi)=\frac{\xi^2}4\left[1+(\zeta_x^2-\zeta_y^2)\cos(2k_L\phi-2m_L\varPhi_0)\right]
\end{align}
In the expression of the electric field we perform another change of variables from $ct$ to $\phi=ct-z$, using
\begin{align}
    d\phi = c (1-\beta_z(\phi)) dt = c\frac1{1+F(\phi)} dt,\qquad \rightarrow \qquad dt=\frac1c d\phi(1+F(\phi))
\end{align}
\begin{align}
    {\bm E}({\bm x},k) =\frac{-i k e_0 e^{ik |{\bm x}_0|}}{4\pi\epsilon_0|{\bm x}_0|}\frac1{\sqrt{2\pi}}\int\limits_{-\infty}^{\infty}d\phi\left[{{\bm n}_0\times({\bm n}_0\times\tilde{\boldsymbol\beta}(\phi))}\right]e^{ik(\phi +z(\phi)-{{\bm n}_0\cdot{\bm r}_0(\phi)})}
\end{align}
...
\begin{align}
    ...
    \left[\frac{\xi^2}4\left[\phi+\frac{(\zeta_x^2-\zeta_y^2)\sin(2k_L\phi-2m_L\varPhi_0)}{2k_L}\right] +z_i        \right]\nonumber                                                                                                                                                    \\
                                               & -\frac{\xi}{k_L}\sin\theta_0\left[\cos\phi_0\zeta_x\sin(k_L\phi-m_L\varPhi_0)-\sin\phi_0\zeta_y\cos(k_L\phi-m_L\varPhi_0)\right]\nonumber                                                                                              \\
    =                                          & (1-\cos\theta_0)\frac{\xi^2}4\phi+(1-\cos\theta_0)
    \left(\frac{\xi^2}4\frac{(\zeta_x^2-\zeta_y^2)\sin(2k_L\phi-2m_L\varPhi_0)}{2k_L} +z_i       \right)\nonumber                                                                                                                                                                       \\
                                               & -\frac{\xi}{k_L}\sin\theta_0\sqrt{\cos^2\phi_0\zeta_x^2+\sin^2\phi_0\zeta_y^2}\nonumber                                                                                                                                                \\
                                               & \quad \times\left[\sin(k_L\phi-m_L\varPhi_0)\frac{\cos\phi_0\zeta_x}{\sqrt{\cos^2\phi_0\zeta_x^2+\sin^2\phi_0\zeta_y^2}}-\cos(k_L\phi-m_L\varPhi_0)\frac{\sin\phi_0\zeta_y}{\sqrt{\cos^2\phi_0\zeta_x^2+\sin^2\phi_0\zeta_y^2}}\right]
\end{align}
...
\end{align}
\begin{align}
    \phi+({\bm n}_L-{\bm n}_0)\cdot{\bm r}_0(\phi)= & \phi\left(1+n_L\cdot n_0\frac{\xi^2}4\right)-\Gamma_0\sin(k_L\phi-m_L\varPhi_0-\gamma_0)+\Delta_0\sin(2k_L\phi-2m_L\varPhi_0)+Z_0
\end{align}
...
we have
\begin{align}
    e^{ik(\phi +z(\phi)-{{\bm n}_0\cdot{\bm r}_0(\phi)})} & =e^{ikZ_0}e^{ik\phi(1+n_L\cdot n_0\frac{\xi^2}4)}\sum\limits_{n=-\infty}^{\infty}J_n(k\Gamma_0)e^{-in(k_L\phi-m_L\varPhi_0-\gamma_0)}\sum\limits_{p=-\infty}^{\infty}J_p(k\Delta_0)e^{ip2(k_L\phi-m_L\varPhi_0)}\nonumber \\
                                                          & =e^{ikZ_0}e^{ik\phi(1+n_L\cdot n_0\frac{\xi^2}4)}\sum\limits_{n=-\infty}^{\infty}\sum\limits_{p=-\infty}^{\infty}e^{in\gamma_0}J_n(k\Gamma_0)J_p(k\Delta_0)e^{-i(n-2p)(k_L\phi-m_L\varPhi_0)}
\end{align}
Change the summation index
\begin{align}
    n-2p = M,\qquad n= M+2p
\end{align}
\begin{align}
    e^{ik(\phi +z(\phi)-{{\bm n}_0\cdot{\bm r}_0(\phi)})} & =e^{ikZ_0}e^{ik\phi(1+n_L\cdot n_0\frac{\xi^2}4)}\sum\limits_{M=-\infty}^{\infty}e^{-iMk_L\phi}e^{iMm_L\varPhi_0}\sum\limits_{p=-\infty}^{\infty}e^{i(M+2p)\gamma_0}J_{M+2p}(k\Gamma_0)J_p(k\Delta_0)
\end{align}
Define a generalized Bessel function
\begin{align}
    \tilde J_M(k;\gamma_0, \Gamma_0, \Delta_0) = \sum\limits_{p=-\infty}^{\infty}e^{i(M+2p)\gamma_0}J_{M+2p}(k\Gamma_0)J_p(k\Delta_0)
\end{align}
$\tilde J$ depends on the argument $k$ and the parameters $\gamma_0$, $\Gamma_0$, $\Delta_0$.
Then
\begin{align}
    e^{ik(\phi +z(\phi)-{{\bm n}_0\cdot{\bm r}_0(\phi)})} & =e^{ik\phi(1+n_L\cdot n_0\frac{\xi^2}4)}\sum\limits_{M=-\infty}^{\infty}e^{-iMk_L\phi}e^{iMm_L\varPhi_0+ikZ_0}\tilde J_M(k;\gamma_0,\Gamma_0,\Delta_0)
\end{align}
\begin{align}
...
and
\begin{align}
    {\bm n}_0\times({\bm n}_0\times\tilde{\boldsymbol{\beta}})  = & \xi\left[{\boldsymbol{\nu}}_{0x}\frac12\zeta_x\left(e^{i(k_L\phi -m_L\varPhi_0)}+e^{-i(k_L\phi-m_L\varPhi_0)}\right)+{\boldsymbol{\nu}}_{0y}\frac1{2i}\zeta_y\left(e^{i(k_L\phi -m_L\varPhi_0)}-e^{-i(k_L\phi-m_L\varPhi_0)}\right)\right]\nonumber \\
                                                                  & + \frac{\xi^2}4{\boldsymbol{\nu}_{0z}}\left[1+(\zeta_x^2-\zeta_y^2)\cos(2k_L\phi-2m_L\varPhi_0)\right]                                                                                                                                              \\
    =                                                             & \frac{\xi}2{\boldsymbol{\nu}}_{-} e^{i(k_L\phi -m_L\varPhi_0)}+\frac{\xi}2{\boldsymbol{\nu}}_{+}e^{-(ik_L\phi -m_L\varPhi_0)}\nonumber                                                                                                              \\&+\frac{\xi^2}4{\boldsymbol{\nu}_{0z}}\left[1+\frac{(\zeta_x^2-\zeta_y^2)}2e^{2i(k_L\phi-m_L\varPhi_0)}+\frac{(\zeta_x^2-\zeta_y^2)}2e^{-2i(k_L\phi-m_L\varPhi_0)}\right]\end{align}

With these the Fourier transform of the electric field becomes
\begin{align}
    {\bm E}({\bm x},k) =\frac{-i k e_0 e^{ik |{\bm x}_0|}}{4\pi\epsilon_0|{\bm x}_0|}\frac1{\sqrt{2\pi}}\int\limits_{-\infty}^{\infty}d\phi & e^{ik\phi(1+n_L\cdot n_0\frac{\xi^2}4)}\sum\limits_{M=-\infty}^{\infty}e^{-iMk_L\phi}e^{iMm_L\varPhi_0+ikZ_0}\tilde J_M(k;\gamma_0,\Gamma_0,\Delta_0)\nonumber \\& \times\left\{\frac{\xi}2{\boldsymbol{\nu}}_{-} e^{i(k_L\phi -m_L\varPhi_0)}+\frac{\xi}2{\boldsymbol{\nu}}_{+}e^{-(ik_L\phi -m_L\varPhi_0)}\right.\nonumber                                                                                                              \\&+\left.\frac{\xi^2}4{\boldsymbol{\nu}_{0z}}\left[1+\frac{(\zeta_x^2-\zeta_y^2)}2e^{2i(k_L\phi-m_L\varPhi_0)}+\frac{(\zeta_x^2-\zeta_y^2)}2e^{-2i(k_L\phi-m_L\varPhi_0)}\right]\right\}\nonumber\\
                                                                                                                                            & =\sum\limits_{K=-2,2}E_K({\bm x},k)
\end{align}
with
\begin{align}
    E_0({\bm x},k) = & \frac{\xi^2}4{\boldsymbol{\nu}_{0z}}   \frac{-i k e_0 e^{ik |{\bm x}_0|}}{4\pi\epsilon_0|{\bm x}_0|}\frac1{\sqrt{2\pi}}\int\limits_{-\infty}^{\infty}d\phi  e^{ik\phi(1+n_L\cdot n_0\frac{\xi^2}4)}\sum\limits_{M=-\infty}^{\infty}e^{-iMk_L\phi}e^{iMm_L\varPhi_0+ikZ_0}\tilde J_M(k;\gamma_0,\Gamma_0,\Delta_0)\nonumber                                                                 \\
                     & =\frac{\xi^2}4{\boldsymbol{\nu}_{0z}}   \frac{-i k e_0 e^{ik (|{\bm x}_0|+Z_0)}}{4\pi\epsilon_0|{\bm x}_0|}\frac1{\sqrt{2\pi}}\sum\limits_{M=-\infty}^{\infty} e^{iMm_L\varPhi_0}\tilde J_M(k;\gamma_0,\Gamma_0,\Delta_0)\int\limits_{-\infty}^{\infty}d\phi                                                                e^{ik\phi(1+n_L\cdot n_0\frac{\xi^2}4)}e^{-iMk_L\phi}\nonumber \\
                     & =\frac{\xi^2}4{\boldsymbol{\nu}_{0z}}   \frac{-i k e_0 e^{ik (|{\bm x}_0|+Z_0)}}{4\pi\epsilon_0|{\bm x}_0|}{\sqrt{2\pi}}\sum\limits_{M=-\infty}^{\infty} e^{iMm_L\varPhi_0}\tilde J_M(k;\gamma_0,\Gamma_0,\Delta_0)\delta(                                                            \alpha k-Mk_L)\nonumber                                                                              \\
\end{align}
where
\begin{align}
    \alpha = 1+n_L\cdot n_0\frac{\xi^2}4
\end{align}

\begin{align}
    E_{\pm1}({\bm x},k) = & \frac{\xi}2{\boldsymbol{\nu}_{\pm}}   \frac{-i k e_0 e^{ik (|{\bm x}_0|+Z_0)}}{4\pi\epsilon_0|{\bm x}_0|}\frac1{\sqrt{2\pi}}\int\limits_{-\infty}^{\infty}d\phi  e^{ik\phi\alpha}\sum\limits_{M=-\infty}^{\infty}e^{-i(M\pm1)k_L\phi}e^{i(M\pm1)m_L\varPhi_0}\tilde J_M(k;\gamma_0,\Gamma_0,\Delta_0)\nonumber          \\
    =                     & \frac{\xi}2{\boldsymbol{\nu}_{\pm}}   \frac{-i k e_0 e^{ik (|{\bm x}_0|+Z_0)}}{4\pi\epsilon_0|{\bm x}_0|}{\sqrt{2\pi}}\sum\limits_{M=-\infty}^{\infty} e^{i(M\pm1)m_L\varPhi_0}\tilde J_M(k;\gamma_0,\Gamma_0,\Delta_0)\delta(                                                            \alpha k-(M\pm1)k_L)\nonumber \\
    =                     & \frac{\xi}2{\boldsymbol{\nu}_{\pm}}   \frac{-i k e_0 e^{ik (|{\bm x}_0|+Z_0)}}{4\pi\epsilon_0|{\bm x}_0|}{\sqrt{2\pi}}\sum\limits_{M=-\infty}^{\infty} e^{iMm_L\varPhi_0}\tilde J_{M\mp1}(k;\gamma_0,\Gamma_0,\Delta_0)\delta(                                                            \alpha k-Mk_L)
\end{align}

\begin{align}
    E_{\pm2}({\bm x},k) = & \frac{\xi}8{\boldsymbol{\nu}_{0z}}  (\zeta_x^2-\zeta_y^2) \frac{-i k e_0 e^{ik (|{\bm x}_0|+Z_0)}}{4\pi\epsilon_0|{\bm x}_0|}\frac1{\sqrt{2\pi}}\int\limits_{-\infty}^{\infty}d\phi  e^{ik\phi\alpha}\sum\limits_{M=-\infty}^{\infty}e^{-i(M\pm2)k_L\phi}e^{i(M\pm2)m_L\varPhi_0}\tilde J_M(k;\gamma_0,\Gamma_0,\Delta_0)\nonumber            \\
    =                     & \frac{\xi^2}8{\boldsymbol{\nu}_{0z}} (\zeta_x^2-\zeta_y^2)  \frac{-i k e_0 e^{ik (|{\bm x}_0|+Z_0)}}{4\pi\epsilon_0|{\bm x}_0|}{\sqrt{2\pi}}\sum\limits_{M=-\infty}^{\infty} e^{i(M\pm2)m_L\varPhi_0}\tilde J_M(k;\gamma_0,\Gamma_0,\Delta_0)\delta(                                                            \alpha k-(M\pm2)k_L)\nonumber \\
    =                     & \frac{\xi^2}8{\boldsymbol{\nu}_{0z}}(\zeta_x^2-\zeta_y^2)   \frac{-i k e_0 e^{ik (|{\bm x}_0|+Z_0)}}{4\pi\epsilon_0|{\bm x}_0|}{\sqrt{2\pi}}\sum\limits_{M=-\infty}^{\infty} e^{iMm_L\varPhi_0}\tilde J_{M\mp2}(k;\gamma_0,\Gamma_0,\Delta_0)\delta(                                                            \alpha k-Mk_L)
\end{align}
With the notations
\begin{align}
