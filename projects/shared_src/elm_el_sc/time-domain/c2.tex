...
\end{align}
In the expression above, $\pmb{\mathfrak{R}}_0$ is the constant reference point used to translate the frame origin, introduced in the previous chapter; in this long-distance expansion it is convenient to take it as the initial position of the particle, but the formulas above hold for any fixed choice of $\pmb{\mathfrak{R}}_0$. $r(\tau)$ and $x\equiv(ct,{\bf x})$ are the absolute trajectory and respectively the absolute observation point, while the quantities denoted with the index $_0$ are measured with respect to $\pmb{\mathfrak{R}}_0$ according to the equations above.
