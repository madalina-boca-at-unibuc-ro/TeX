...
\section[The trajectory for arbitrary initial conditions]{The trajectory for arbitrary initial conditions}\label{sec:smooth-mono-trajectory}
...
\begin{align}
   ...
   & z(\phi)=\mathcal{R}_{0}^{3}+\int_{\phi_{0}}^{\phi} d \chi\left[\frac{e_{0}^{2} \boldsymbol{\mathcal { A }}^{2}(\chi)-e_{0}^{2} \boldsymbol{\mathcal { A }}_{0}^{2}}{2\left(n \cdot p_{0}\right)^{2}}+\frac{\widetilde p_{0}^{3}}{n \cdot p_{0}}\right] = \int_{0}^{\phi} d \chi\left[\frac{e_{0}^{2} \mathbf{A}^{2}(\chi)}{2\left(n \cdot p_{0}\right)^{2}}+\frac{p_{0}^{3}}{n \cdot p_{0}}\right]\label{trajectory_mono_gamma_head_on}
\end{align}
