...
\begin{highlightbox}[title={Cartesian electric field}]
    \begin{align}
...
\begin{highlightbox}[title={Cartesian magnetic field}]
    \begin{align}
...
\begin{highlightbox}[title={Electric field for an arbitrary propagation direction}]
    \begin{align}
...
\begin{highlightbox}[title={Magnetic field for an arbitrary propagation direction}]
    \begin{align}
