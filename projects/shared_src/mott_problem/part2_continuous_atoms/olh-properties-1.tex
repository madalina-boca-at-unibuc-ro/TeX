...
\begin{align}
  \langle n | e^{-iqx} | m \rangle = \sqrt{\frac{n_<!}{n_>!}} \left(-\frac{i q }{\sqrt{2}\alpha }\right)^{n_> - n_<} e^{-\frac{q^2 }{4\alpha ^2}} \, L_{n_<}^{(n_> - n_<)}\!\left(\frac{q^2 }{2\alpha ^2}\right)\label{me-ho}
\end{align}
...
\section{Calculation of the matrix element ${\cal V}$ in the displaced harmonic oscillator basis}\label{cal-V_olh-basis}
...
\begin{importantbox}
  \begin{align}
    {\cal V}(n_1,n_2;P_1,P_2;a)&= \langle n_1(a) P_1|H_I|n_2(a) P_2\rangle  \nonumber\\
    &= \frac{V_0}{2\pi\hbar}\sqrt{{2\pi\sigma_V^2}} e^{-\frac{i}{\hbar}a(P_1-P_2)}e^{-\frac{(P_1-P_2)^2\sigma_V^2}{2\hbar^2}}\sqrt{\frac{n_<!}{n_>!}} \left(-\frac{i (P_1-P_2)  }{\sqrt{2}\hbar\alpha}\right)^{n_> - n_<} e^{-\frac{(P_1-P_2)^2 }{4\hbar^2\alpha^2}} \, L_{n_<}^{(n_> - n_<)}\!\left(\frac{(P_1-P_2)^2 }{2\hbar^2\alpha^2}\right)\label{cal-V_n1n2p1p2}
  \end{align}
  ...
  \begin{align}
    ...
    \delta_{n_1n_2}.\label{cal-V_n1n2p1p2-spec}
  \end{align}
\end{importantbox}
