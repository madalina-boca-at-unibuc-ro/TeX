...
\begin{importantbox}
  \begin{align}
    F^{\alpha\beta}(ck,{\bf x})=\frac1{2\pi}\frac{e}{4\pi\epsilon_0c^2}\int\limits_{-\infty}^{\infty}d\tau \frac{e^{ik\left(r_0^0(\tau)+|{\bf x}_0-{\bf r}_0(\tau)|\right)}}{|{\bf R}_0|}\frac{(u\cdot R_0)(R_0^{\alpha}w^{\beta}-R_0^{\beta}w^{\alpha})
    -((w\cdot R_0)-c^2)(R_0^{\alpha}u^{\beta}-R_0^{\beta}u^{\alpha})}
...
\begin{align}
  F_l^{\alpha\beta}(ck,{\bf x}) & =\frac1{2\pi}\frac{e}{4\pi\epsilon_0c^2}\int\limits_{-\infty}^{\infty}d\tau \frac{e^{ik\left(r_0^0+|{\bf R}_0|\right)}}{|{\bf R}_0|}\frac{(u\cdot R_0)(R_0^{\alpha}w^{\beta}-R_0^{\beta}w^{\alpha})-(w\cdot R_0)(R_0^{\alpha}u^{\beta}-R_0^{\beta}u^{\alpha})}
  {(u\cdot R_0)^2}\nonumber                                                                                                                                                                                                                                                \\
  & =\frac1{2\pi}\frac{e}{4\pi\epsilon_0c^2}\int\limits_{-\infty}^{\infty}d\tau \frac{e^{ik\left(r_0^0+|{\bf R}_0\right)}}{|{\bf R}_0|}\frac{(u\cdot n_{R_0})(n_{R_0}^{\alpha}w^{\beta}-n_{R_0}^{\beta}w^{\alpha})-(w\cdot n_{R_0})(n_{R_0}^{\alpha}u^{\beta}-n_{R_0}^{\beta}u^{\alpha})}
  {(u\cdot n_{R_0})^2}
\end{align}
and similarly
\begin{align}
  F_s^{\alpha\beta}(ck,{\bf x})=\frac1{2\pi}\frac{e c^2}{4\pi\epsilon_0c^2}\int\limits_{-\infty}^{\infty}d\tau \frac{e^{ik\left(r_0^0+|{\bf R}_0|\right)}}{|{\bf R}_0|}\frac{(R_0^{\alpha}u^{\beta}-R_0^{\beta}u^{\alpha})}
  {(u\cdot R_0)^2}=\frac1{2\pi}\frac{e}{4\pi\epsilon_0}\int\limits_{-\infty}^{\infty}d\tau \frac{e^{ik\left(r_0^0+|{\bf R}_0|\right)}}{|{\bf R}_0|^2}\frac{(n_{R_0}^{\alpha}u^{\beta}-n_{R_0}^{\beta}u^{\alpha})}
  {(u\cdot n_{R_0})^2}
\end{align}

The final results are
\begin{highlightbox}[title={Exact Fourier-transformed Faraday tensor}]
  \begin{align}
    F^{\alpha\beta}(c k,{\bf x})  & = F^{\alpha\beta}_{l}(c k,{\bf x}) + F^{\alpha\beta}_{s}(c k,{\bf x}),
    \\
    F_l^{\alpha\beta}(ck,{\bf x}) & =\frac1{2\pi}\frac{e}{4\pi\epsilon_0c^2}\int\limits_{-\infty}^{\infty}d\tau \frac{e^{ik\left(r_0^0+|{\bf R}_0\right)}}{|{\bf R}_0|}\frac{(u\cdot n_{R_0})(n_{R_0}^{\alpha}w^{\beta}-n_{R_0}^{\beta}w^{\alpha})-(w\cdot n_{R_0})(n_{R_0}^{\alpha}u^{\beta}-n_{R_0}^{\beta}u^{\alpha})}
    {(u\cdot n_{R_0})^2}                                                                                                                                                                                                                                             \\
    F_s^{\alpha\beta}(ck,{\bf x}) & =\frac1{2\pi}\frac{e}{4\pi\epsilon_0}\int\limits_{-\infty}^{\infty}d\tau \frac{e^{ik\left(r_0^0+|{\bf R}_0|\right)}}{|{\bf R}_0|^2}\frac{(n_{R_0}^{\alpha}u^{\beta}-n_{R_0}^{\beta}u^{\alpha})}
    {(u\cdot n_{R_0})^2}
  \end{align}
\end{highlightbox}
