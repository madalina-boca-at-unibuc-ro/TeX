...
\end{align}
here $C(P)$ is the projectile momentum coefficient of Part~\ref{part-general-tdpt}, Sect.~\ref{sect_bimodal}, given by (\ref{C(P)-projectile}) and, for $P_0\gg\hbar/\sigma_\alpha$, approximated by (\ref{C(P)-projectile-approx}).
