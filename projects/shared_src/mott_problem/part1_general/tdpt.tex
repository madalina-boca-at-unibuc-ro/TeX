...
\newpage
\section{the Dyson series of the time evolution operator}\label{sect:general-tdpt}
...
\end{align}
\newpage
\section{the first order transition amplitude in the general case}
...
in the Mott case, with one absorber present, the interaction hamiltonian is independent of time, so its matrix elements \(\langle \gamma' |H_I| \gamma\rangle\) can be taken out of the integral:
\begin{align}
...
the integral is
\begin{align}
    \int\limits_{t_i}^{t_f}dt_1e^{\frac{i}{\hbar}(E_{\gamma_f}-E_{\gamma} )t_1}= \frac{\hbar}i\frac{e^{\frac{i}\hbar (E_{\gamma_f} -E_{\gamma})t_f}-e^{\frac{i}\hbar (E_{\gamma_f} -E_{\gamma})t_i}}{E_{\gamma_f}-  E_{\gamma}}
\end{align}
and the transition amplitude becomes
\begin{align}
    {\cal A}_{fi}^{(1)} = \sum_\gamma \frac{c_\gamma^{(i)}}{-E_{\gamma_f}- E_{\gamma}} \langle \gamma_f|H_I|\gamma\rangle  \left(e^{-\frac{i}{\hbar}E_{\gamma}(t_f-t_i)}-e^{-\frac{i}{\hbar}E_{\gamma_f}(t_f-t_i)}\right)
\end{align}
which can be rewritten as
\begin{importantbox}
    \begin{align}
        {\cal A}_{fi}^{(1)} & =\sum_\gamma {c_\gamma^{(i)}}\langle \gamma_f|H_I|\gamma\rangle  \frac{\left(e^{-\frac{i}{\hbar}E_{\gamma_f}(t_f-t_i)}-e^{-\frac{i}{\hbar}{ E_\gamma}(t_f-t_i)} \right)}{{E_{\gamma_f}- E_\gamma}} \equiv \sum_\gamma {c_\gamma^{(i)}}\langle \gamma_f|H_I|\gamma\rangle   {\cal E}(E_{\gamma_f},E_{\gamma})\label{eq:gen-first-order-amplitude}
    \end{align}
    with
    \begin{align}
    ...
    \end{align}
    The factor above is discussed in Sect \ref{sec:app-stable-first-order}
\end{importantbox}
...
\begin{align}
    p_{fi}^{(1)} = \left| \mathcal{A}_{fi}^{(1)} \right|^2 = \left|\sum_\gamma {c_\gamma^{(i)}}\langle \gamma_f|H_I|\gamma\rangle   {\cal E}(E_{\gamma_f},E_{\gamma})\right|^2\label{eq:gen-first-order-probability}
\end{align}
\newpage
\section{the second order transition amplitude in the general case}
...
\begin{align}
    ...
    & = \left(\frac{1}{i\hbar}\right)^2 \sum\limits_{\gamma,\gamma_f,\gamma_1}c_{\gamma_f}^{(f)*} c_{\gamma}^{(i)}\int\limits_{t_i}^{t_f}dt_2\int\limits_{t_i}^{t_2}dt_1e^{-\frac{i}{\hbar}E_{\gamma_f} (t_f-t_2)}e^{-\frac{i}{\hbar}E_{\gamma_1}(t_2-t_1)}e^{-\frac{i}{\hbar}E_{\gamma}(t_1-t_i)}\langle \gamma_f |H_I(t_2)| \gamma_1\rangle\langle \gamma_1 |H_I(t_1)| \gamma\rangle\nonumber                                  \\
    & =\left(\frac{1}{i\hbar}\right)^2 \sum\limits_{\gamma,\gamma_f,\gamma_1}c_{\gamma_f}^{(f)*} c_{\gamma}^{(i)}e^{-\frac{i}{\hbar}E_{\gamma_f} t_f}e^{\frac{i}{\hbar}E_{\gamma} t_i}\int\limits_{t_i}^{t_f}dt_2\int\limits_{t_i}^{t_2}dt_1e^{\frac{i}{\hbar}(E_{\gamma_f}-E_{\gamma_1})t_2}e^{\frac{i}{\hbar}(E_{\gamma_1}-E_{\gamma})t_1}\langle \gamma_f |H_I(t_2)| \gamma_1\rangle\langle \gamma_1 |H_I(t_1)| \gamma\rangle
\end{align}
...
\begin{align}
    ...
    & \quad =\int\limits_{t_i}^{t_f}dt_2e^{\frac{i}{\hbar}(E_{\gamma_f}-E_{\gamma_1})t_2}\frac{\hbar}{i(E_{\gamma_1}-E_{\gamma})}\left(e^{\frac{i}{\hbar}(E_{\gamma_1}-E_{\gamma})t_2}-e^{\frac{i}{\hbar}(E_{\gamma_1}-E_{\gamma})t_i}\right)\nonumber                                                                                                                                                                                                               \\
    & \quad =\frac{\hbar}{i(E_{\gamma_1}-E_{\gamma})}\int\limits_{t_i}^{t_f}dt_2 e^{\frac{i}{\hbar}(E_{\gamma_f}-E_{\gamma})t_2}-\frac{\hbar}{i(E_{\gamma_1}-E_{\gamma})}e^{\frac{i}{\hbar}(E_{\gamma_1}-E_{\gamma})t_i}\int\limits_{t_i}^{t_f}dt_2e^{\frac{i}{\hbar}(E_{\gamma_f}-E_{\gamma_1})t_2}\nonumber                                                                                                                                                        \\
    & \quad =\frac{\hbar}{i(E_{\gamma_1}-E_{\gamma})}\frac{\hbar}{i(E_{\gamma_f}-E_{\gamma})}\left(e^{\frac{i}{\hbar}(E_{\gamma_f}-E_{\gamma})t_f}-e^{\frac{i}{\hbar}(E_{\gamma_f}-E_{\gamma})t_i}\right)-\frac{\hbar}{i(E_{\gamma_1}-E_{\gamma})}e^{\frac{i}{\hbar}(E_{\gamma_1}-E_{\gamma})t_i}\frac{\hbar}{i(E_{\gamma_f}-E_{\gamma_1})}\left(e^{\frac{i}{\hbar}(E_{\gamma_f}-E_{\gamma_1})t_f}-e^{\frac{i}{\hbar}(E_{\gamma_f}-E_{\gamma_1})t_i}\right)\nonumber \\
\end{align}
including also the exponentials in front of the exponentials from (\ref{eq:gen-second-order-intermediate})
\begin{align}
...
\begin{align}
    {\cal A}_{fi}^{(2)} = & \sum_{\gamma, \gamma_1} c_{\gamma}^{(i)}\langle\gamma_f|H_I|\gamma_1\rangle \langle\gamma_1|H_I|\gamma\rangle\nonumber                                                                                                                                                                  \\
    & \frac{1}{(E_{\gamma_1}-E_{\gamma})} \times\left[ \frac{1}{(E_{\gamma_f}-E_{\gamma})}\left(e^{-\frac{i}{\hbar}E_{\gamma}(t_f-t_i)}-e^{-\frac{i}{\hbar}E_{\gamma_f}(t_f-t_i)}\right)-\frac{1}{(E_{\gamma_f}-E_{\gamma_1})}\left(e^{-\frac{i}{\hbar}E_{\gamma_1}(t_f-t_i)}-e^{-\frac{i}{\hbar}E_{\gamma_f}(t_f-t_i)}\right) \right]
\end{align}
...
\begin{importantbox}
    \begin{align}
        ...
        & {\cal F}(E_{\gamma_f}, E_{\gamma_1},E_\gamma) = \frac{1}{(E_{\gamma_1}-E_{\gamma})} \times\left[ \frac{1}{(E_{\gamma_f}-E_{\gamma})}\left(e^{-\frac{i}{\hbar}E_{\gamma}(t_f-t_i)}-e^{-\frac{i}{\hbar}E_{\gamma_f}(t_f-t_i)}\right)-\frac{1}{(E_{\gamma_f}-E_{\gamma_1})}\left(e^{-\frac{i}{\hbar}E_{\gamma_1}(t_f-t_i)}-e^{-\frac{i}{\hbar}E_{\gamma_f}(t_f-t_i)}\right) \right]\label{eq:gen-second-order-amplitude}
    \end{align}
