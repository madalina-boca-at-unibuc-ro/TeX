...
\section{Fourier analysis of the emitted fields - lowest order approximation}

Here we consider only the lowest order approximation of the electromagnetic fields emitted by a particle of charge $e_0$
\begin{align}
...
\begin{align}
    \frac{d}{dt}\frac{{\bm n}_0\times({\bm n}_0\times{\boldsymbol\beta})}{1-{\boldsymbol{\beta}\cdot{\bm n}_0}} & =\frac{{\bm n}_0\times({\bm n}_0\times{\bm a})}{c(1-{\boldsymbol{\beta}\cdot{\bm n}_0})}+\frac{{\bm n}_0\times({\bm n}_0\times{\boldsymbol \beta})}{c(1-{\boldsymbol{\beta}\cdot{\bm n}_0})^2}({\bm n_0}\cdot{\bm a})\nonumber                                                                                                                                          \\
...
\section{The trajectory of a particle in a monochromatic field}

Consider a particle, initially in the position
\begin{align}
