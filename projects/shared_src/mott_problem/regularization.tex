...
\begin{align}\Delta t=t_f-t_i, \qquad
    \tau=\frac{\Delta t}{\hbar},\end{align}
...
\begin{align}\operatorname{sinc}z=\frac{\sin z}{z}, \qquad
    \operatorname{sinc}(0)=1.\end{align}

\subsection{ First $\operatorname{sinc}$ transformation}

Use the identity
\begin{align} e^{-ix}-e^{-iy} = -i(x-y)e^{-i(x+y)/2}\operatorname{sinc}\left(\frac{x-y}{2}\right).\end{align}
...
\begin{align} E_{\gamma_f}\to E_\gamma \qquad\text{and}\qquad
    E_{\gamma_f}\to E_{\gamma_1}.\end{align}
...
\begin{align}\mathcal A = i\tau
    \frac{g(E_\gamma, E_{\gamma_f})-g(E_{\gamma_1},E_{\gamma_f})}{E_{\gamma_1}-E_\gamma}.\end{align}
...
\begin{align} z=\frac{\tau(E_\gamma-E_{\gamma_f})}{2}. \end{align}
...
\begin{align}\boxed{
        {\cal F} (E_\gamma,E_\gamma,E_{\gamma_f})
        =
        -\frac{\tau^2}{2}
        e^{-i\tau(E_\gamma+E_{\gamma_f})/2}
        \left[
            ...
            +i\,\operatorname{sinc}'z
            \right]
        ,\quad z= \frac{\tau(E_\gamma-E_{\gamma_f})}{2},\quad \operatorname{sinc}'z = \frac{z\cos z-\sin z}{z^2},\quad \operatorname{sinc}'(0)=0}\end{align}
...
If
\begin{align} E_\gamma=E_{\gamma_1}=E_{\gamma_f}, \end{align}
then $z=0$, and therefore
\begin{align}\operatorname{sinc}(0)=1, \qquad
    \operatorname{sinc}'(0)=0.\end{align}
...
In particular,
\begin{align}\operatorname{sinc}(0)=1, \end{align}
